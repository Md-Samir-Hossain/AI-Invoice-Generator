...
export async function updateInvoice(req, res) {
  try {
    ...
    const query = isObjIdString(id) ? {_id: id, owner: userId} : {invoiceNumber: id, owner: userId};
    ...
    // If user changes the invoice number, ensure that it not exists or not in use
