...
export const appShellStyles = {
  ...
  logoWithTextImage: "h-16 object-contain drop-shadow-sm",
  logoTextContainer: "",
  ...
  mobileLogoWithTextImage: "h-10 object-contain",
  ...
  welcomeName: "bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent whitespace-nowrap",
...
export const pricingStyles = {
  ...
  // Background Elements
  bgElement1: "absolute -top-26 left-0 w-72 h-72 bg-amber-100 rounded-full  filter blur-xl opacity-70 animate-blob-3",
